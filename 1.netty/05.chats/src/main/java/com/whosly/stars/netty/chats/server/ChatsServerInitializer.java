package com.whosly.stars.netty.chats.server;
...
class ChatsServerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel socketChannel) throws Exception {
        ...
        // 添加自定义的Message编解码器
        pipeline.addLast(new com.whosly.stars.netty.chats.codec.MessageDecoder());
        pipeline.addLast(new com.whosly.stars.netty.chats.codec.MessageEncoder());
